...
docker exec -it mysql_containers /usr/bin/mysqldump -uroot -p'0o0o0o!@#dayingjia'  --all-databases  --hex-blob  --force --flush-logs --routines --log-error=/mysql/err${mydate}.log > /mysql/db${mydate}.sql
